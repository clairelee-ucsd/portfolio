...
//                   project.year.toString() === newData[idx].label && 
//                   Object.values(project).join('\n').toLowerCase().includes(query.toLowerCase())
//               );
//                 //let filteredProjects = projects.filter(project => project.year.toString() === newData[idx].label);
...
//       legend.selectAll('.legend li').remove();
